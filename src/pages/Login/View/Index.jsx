...
function LoginPage({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (userType === "agent") {
      // Demo login for sales agents (password: "0000")
      if (password === "0000") {
        const userData = {
        ...
        <form onSubmit={handleSubmit} style={{ width: "100%" }}>
          ...
          <Box sx={{ mt: 2, mb: 2, p: 2, bgcolor: "#f5f5f5", borderRadius: 1 }}>
            <Typography variant="body2" color="text.secondary">
              <strong>Demo Instructions (Sales Agent only):</strong> Enter any email address and use password "0000" to sign in as a Sales Agent. For Customer login, use your registered email and password.
            </Typography>
          </Box>
